...
CREATE TABLE `departamentos` (
  `empresa` varchar(2) NOT NULL -- TODO: empresa y sucursal 01 en todo
  `sucursal` varchar(2) NOT NULL COMMENT 'name of the sucursal',
  `coddepar` varchar(3) NOT NULL COMMENT '[automatic] code of the department', -- TODO:
...
CREATE TABLE `gruposaf` (
  ...
  `ctagasto` varchar(20) DEFAULT NULL COMMENT '[solo lectura]' -- TODO:
  `ctaacum` varchar(20) DEFAULT NULL COMMENT '[solo lectura]', -- TODO:
  `empresa` char(2) DEFAULT '01',
  `sucursal` char(2) DEFAULT '01',
  `codgrupo` char(3) DEFAULT --TODO: poner en automatico
  PRIMARY KEY (`id`),
